...
export function Alarm(props: EntryType["alarms"][number]) {
  ...
  return (
    <li key={props.id} data-disp="flex" data-gap="2" data-mt="3">
      <div data-disp="flex" data-cross="center" data-gap="2" data-fs="sm" data-color="neutral-300">
      ...
      <div data-disp="flex" data-cross="center" data-gap="2" data-fs="sm" data-color="brand-100">
