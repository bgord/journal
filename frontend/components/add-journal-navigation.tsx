...
export function AddJournalNavigation(props: { step: AddJournalNavigationStep }) {
  ...
  return (
    <div data-display="flex" data-cross="center" data-mx="auto" data-gap="6" data-ls="0.5" data-mb="12">
      {props.step === "situation" && <img src="/pencil.svg" height="15px" alt="Fill up reaction" />}
      ...
      <div data-fw="700">·</div>
      {props.step === "emotion" && <img src="/pencil.svg" height="15px" alt="Fill up reaction" />}
      ...
      <div data-fw="700">·</div>
      {props.step === "reaction" && <img src="/pencil.svg" height="15px" alt="Fill up reaction" />}
