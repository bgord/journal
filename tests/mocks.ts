...
export const PositiveEmotionWithMaladaptiveReactionPatternDetectedEvent = {
  ...
  correlationId,
  createdAt: T0.ms,
  stream: v.parse(bg.EventStream, `weekly_pattern_detection_${userId}_${week.toIsoId()}`),
  version: 1,
  commit,
...
export const MoreNegativeThanPositiveEmotionsPatternDetectedEvent = {
  ...
  correlationId,
  createdAt: T0.ms,
  stream: v.parse(bg.EventStream, `weekly_pattern_detection_${userId}_${previousWeek.toIsoId()}`),
  version: 1,
  commit,
...
export const GenericWeeklyReviewExportByEmailRequestedEvent = {
  ...
  correlationId,
  createdAt: T0.ms,
  stream: v.parse(bg.EventStream, `weekly_review_export_by_email_${weeklyReviewExportId}`),
  version: 1,
  commit,
...
export const GenericShareableLinkCreatedEvent = {
  ...
  correlationId,
  createdAt: T0.ms,
  stream: v.parse(bg.EventStream, `shareable_link_${shareableLinkId}`),
  version: 1,
  commit,
...
export const GenericHourHasPassedEvent = {
  ...
  correlationId,
  createdAt: T0.ms,
  stream: v.parse(bg.EventStream, "passage_of_time"),
  version: 1,
  commit,
...
export const GenericAiRequestRegisteredEmotionsAlarmEntryEvent = {
  ...
  correlationId,
  createdAt: T0.ms,
  stream: v.parse(bg.EventStream, `user_ai_usage_${userId}`),
  version: 1,
  commit,
...
export const GenericEntryHistorySituationLoggedEvent = {
  ...
  correlationId,
  createdAt: T0.ms,
  stream: v.parse(bg.EventStream, `history_${entryId}`),
  version: 1,
  commit,
...
export const GenericUserLanguageSetEvent = {
  ...
  correlationId,
  createdAt: T0.ms,
  stream: v.parse(bg.EventStream, `preferences_${userId}`),
  version: 1,
  commit,
