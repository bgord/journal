...
type EmotionalAdvicePromptType = [
...
export class EmotionalAdvicePrompt {
  constructor(
    private readonly summary: ReturnType<
  ...
  generate(): EmotionalAdvicePromptType {
    ...
    let content = `Here is a summary of a journal entry from my AI journaling app, it triggered an ${this.alarmName} alarm.`;
    ...
    return [
      {
        role: "system",
        content:
          "You are a compassionate mental health coach providing short, practical advice.",
      },
      { role: "user", content: "" },
    ];
  }
